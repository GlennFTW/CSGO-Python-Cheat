...
r = requests.get("https://github.com/GlennFTW/GHax-Private/blob/master/hwid.txt")
...
def Main_Program():
    if hwid in r.text:
        ...
        print("Please contact (Crumb#0986) for help. HWID: " + hwid)
        os.system('pause >NUL')
...
if __name__ == "__main__":
    ...
    print ('..')
    print('\033[31m' + '[*]GHacks')
    printSlow('Injecting Cheat..........')
    print ('.')
    printSlow('Loaded Ghacks!')
